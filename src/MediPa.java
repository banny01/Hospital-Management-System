...
public class MediPa extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
PreparedStatement pst=null;
 ...
 private void Get_Data2(){
      try{
        con=Connect.ConnectDB();
        String sql="select MedicineID as 'Medicine ID', MedicineName as 'Medicine Name' from medicines order by Medicineid";
 ...
 private void Reset()
{
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Medicine for Patient Info"));
       ...
       if (txtServiceName.getText().equals("")) {
        ...
        if (txtServiceDate.getText().equals("")) {
           ...
           return;
            ...
            String sqlchrg = "Select MedicinePrice from medicines where MedicineID = '"+ txtServiceID.getText()+"'";  
            pst=con.prepareStatement(sqlchrg);
            rs=pst.executeQuery();
            rs.next();
            String chrg = rs.getString("MedicinePrice");
      Float charge = Integer.valueOf(txtQty.getText())* Float.valueOf(chrg);
       String sql= "insert into MediPa(ServiceID,ServiceName,ServiceDate,PatientID,QTY,Charge)values('"+ txtServiceID.getText() + "','"+ txtServiceName.getText() + "','" + txtServiceDate.getText() + "','" + txtPatientID.getText() + "','" + txtQty.getText() +"','"+ charge +"')";
       pst=con.prepareStatement(sql);
       pst.execute();
    ...
    try{
            ...
            {
                con=Connect.ConnectDB();
                String sql= "delete from MediPa where ID = " + PSID.getText() + "";
                pst=con.prepareStatement(sql);
                pst.execute();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
      ...
      con=Connect.ConnectDB();
          String sqlchrg = "Select MedicinePrice from medicines where MedicineID = '"+ txtServiceID.getText()+"'";  
            ...
            String chrg = rs.getString("MedicinePrice");
            Float charge = Integer.valueOf(txtQty.getText())* Float.valueOf(chrg);
       String sql= "update MediPa set ServiceID='"+ txtServiceID.getText() + "',Servicename='"+ txtServiceName.getText() + "',ServiceDate='"+ txtServiceDate.getText() + "',PatientID='" + txtPatientID.getText() + "',QTY='" + txtQty.getText() +"',Charge=" + charge + " where PSID=" + PSID.getText() + "";
       pst=con.prepareStatement(sql);
       pst.execute();
    ...
    private void tblServicesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblServicesMouseClicked
        ...
        try{
            ...
            if(rs.next()){
                ...
                String add3=rs.getString("MedicineID");
                txtServiceID.setText(add3);
                String add4=rs.getString("MedicineName");
