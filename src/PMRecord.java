 ...
 * @author BANNY
 */
public class PMRecord extends javax.swing.JFrame {
    ...
    private void Get_Data(){
       String sql="select ID as 'PMID', ServiceID as 'Medicine ID', ServiceName as 'Medicine Name',ServiceDate as 'Service Date',QTY as 'Qty',Charge as 'Total Charge',PatientRegistration.PatientID as 'Patient ID',PatientName as 'Patient Name' from PatientRegistration,MediPa where MediPa.PatientID=PatientRegistration.PatientID order by PatientName";
    ...
    private void pstblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pstblMouseClicked
        ...
        try{
           ...
           String sql=" Select * from PatientRegistration,MediPa where MediPa.PatientID=PatientRegistration.PatientID and ID=" + table_click  + "";
