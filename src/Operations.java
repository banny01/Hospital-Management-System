...
PreparedStatement pst=null;
 ...
 private void Get_Data2(){
      try{
        con=Connect.ConnectDB();
        String sql="select OperationID as 'Operation ID', OperationName as 'Operation Name' from operationreg order by OperationName";
 ...
 private void Reset()
{
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Operation Date");
      ...
      con=Connect.ConnectDB();
       if (txtServiceName.getText().equals("")) {
        ...
        if (txtServiceDate.getText().equals("")) {
           JOptionPane.showMessageDialog( this, "Please enter Operation date","Error", JOptionPane.ERROR_MESSAGE);
           return;
            }
           ...
           return;
            ...
            String sqlchrg = "Select OperationCharge from operationreg where OperationID = '"+ txtServiceID.getText()+"'";  
            pst=con.prepareStatement(sqlchrg);
            rs=pst.executeQuery();
            rs.next();
            String chrg = rs.getString("OperationCharge");
      Float charge = Float.valueOf(chrg);
       String sql= "insert into operations(OperationID,OperationName,OperationDate,PatientID,Charge,Status)values('"+ txtServiceID.getText() + "','"+ txtServiceName.getText() + "','" + txtServiceDate.getText() + "','" + txtPatientID.getText() +"','"+ charge +"','Not Issued')";
       pst=con.prepareStatement(sql);
       pst.execute();
    ...
    try{
            ...
            {
                con=Connect.ConnectDB();
                String sql= "delete from operations where POID = " + PSID.getText() + "";
                pst=con.prepareStatement(sql);
                pst.execute();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
      ...
      con=Connect.ConnectDB();
          String sqlchrg = "Select OperationCharge from operationreg where OperationID = '"+ txtServiceID.getText()+"'";  
            ...
            String chrg = rs.getString("OperationCharge");
            Float charge = Float.valueOf(chrg);
       String sql= "update operations set OperationID='"+ txtServiceID.getText() + "',Operationname='"+ txtServiceName.getText() + "',OperationDate='"+ txtServiceDate.getText() + "',PatientID='" + txtPatientID.getText() +"',Charge=" + charge + " where POID=" + PSID.getText() + "";
       pst=con.prepareStatement(sql);
       pst.execute();
    ...
    private void tblServicesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblServicesMouseClicked
        ...
        try{
            ...
            if(rs.next()){
                ...
                String add3=rs.getString("OperationID");
                txtServiceID.setText(add3);
                String add4=rs.getString("OperationName");
